              ...
              <FormItem class="w-full">
                ...
                <FormControl class="w-full min-w-0">
                  <Input
                    ...
                    readonly
                    class="text-sm"
                    :value="`${productionPlanDetail.productionManagerName} (${productionPlanDetail.productionManagerNo})`"
                  />
              ...
              <FormItem>
                ...
                <FormControl class="w-full min-w-0">
                  <Input
                    ...
                    readonly
                    class="text-sm"
                    :value="`${productionPlanDetail.itemName} (${productionPlanDetail.itemCode})`"
                  />

                  <div v-else-if="selectedFactoryId">
                    <UpdateAutoCompleteSelect
              ...
              <FormItem class="w-full">
                ...
                <FormControl class="w-full min-w-0">
                  <Input
                    ...
                    readonly
                    class="text-sm"
                    :value="`${productionPlanDetail.salesManagerName} (${productionPlanDetail.salesManagerNo})`"
                  />
                  <UpdateAutoCompleteSelect
                    v-else
