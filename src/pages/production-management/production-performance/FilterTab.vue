    ...
    <AccordionItem value="filters">
      ...
      <AccordionContent class="p-4 border-b-2 border-t-2 my-3">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FilterInput label="공장" v-model="localFilters.factoryCode" />
          <FilterInput label="라인" v-model="localFilters.lineCode" />
          ...
          <!-- ────────── 납기일자 ────────── -->
          <FilterInput label="납기일자 From" type="date" v-model="localFilters.dueDateFrom" />
          <FilterInput label="납기일자 To" type="date" v-model="localFilters.dueDateTo" />
