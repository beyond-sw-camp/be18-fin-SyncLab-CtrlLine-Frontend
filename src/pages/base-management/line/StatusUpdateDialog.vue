<template>
  <Dialog>
    ...
    <DialogContent class="rounded-2xl p-6 sm:max-w-[400px]">
      <DialogHeader>
        <DialogTitle class="text-lg font-semibold">라인 사용여부 변경</DialogTitle>
        <DialogDescription class="flex flex-col items-center gap-3 text-gray-600 pt-1">
          <p>정말 선택된 라인의 사용여부를 변경하시겠습니까?</p>
...
import useUpdateLineStatusList from '@/apis/query-hooks/line/useUpdateLineStatusList';
...
const { mutate: callUpdateLine } = useUpdateLineStatusList();
